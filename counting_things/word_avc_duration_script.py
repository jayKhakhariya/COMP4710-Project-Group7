import constants
from add_count_for_duration_column import AddCountForDurationColumn
from transcript_parser.transcript_parser import FieldNames

word = "(laughter)"
duration = 30

dataset_w_word = AddCountForDurationColumn(constants.transcript_en_loc, word, duration).data_set
...
print(f"The largest count for {word} in the first {duration} seconds is {max_word_count}.")
...
print(f"The final {word} avc for the first {duration} seconds is:")
